...
int main(void){
	...
	while(1){
		/*
		 * realiaz operacion de punto flotante cuando se
		 * recibe algun caracter por el puerto serial
		 */
		if(sendMsg > 4){
			...
			writeMsg(&usart2Comm, "Cambiamos de velocidad!");
