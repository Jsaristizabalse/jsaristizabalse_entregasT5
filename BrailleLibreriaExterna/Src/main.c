...
/* ==================================== Configurando los TIMERS =============================================*/
	...
	handlerTimerLed.TIMx_Config.TIMx_period					= 1000;//interrupcion cada 250ms
...
//		clearLEDMatrix();
//	}
//	GPIOxTogglePin(&handlerLED1);
//	GPIOxTogglePin(&GPIO_StructHandlers[0]);
//	GPIOxTogglePin(&GPIO_StructHandlers[1]);
//	GPIOxTogglePin(&GPIO_StructHandlers[2]);
//	GPIOxTogglePin(&GPIO_StructHandlers[3]);
//	GPIOxTogglePin(&GPIO_StructHandlers[4]);
//	GPIOxTogglePin(&GPIO_StructHandlers[5]);
}
